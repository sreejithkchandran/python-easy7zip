...
"""This module will only work on Python 2.7 on the Windows paltform and the only prerequisite  is to install 7zip program in one of the following locations "C:\7Zip","C:\Program Files","C:\Program Files (x86)"""
